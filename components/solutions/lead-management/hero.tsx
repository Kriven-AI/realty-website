...
import { ArrowRight, Layers, ListChecks, Activity } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Glow } from "@/components/ui/glow";

const PROOF = [
  { icon: Layers, label: "Every channel, one place" },
  { icon: ListChecks, label: "Every lead tracked & scored" },
  { icon: Activity, label: "Worked automatically, 24/7" },
];
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center lg:px-8">
        ...
        >
          <span className="text-gradient">
            Real estate lead management that works your leads — not just stores
            them.
          </span>
        </motion.h1>
        ...
        >
          Kriven AI pulls every lead — from 99acres, Meta, Google and your
          website — into one place, tracks each one with a live intent score,
          and actually works them with calls and WhatsApp until the site visit
          is booked. A CRM stores your leads. Kriven AI closes the gap.
        </motion.p>
