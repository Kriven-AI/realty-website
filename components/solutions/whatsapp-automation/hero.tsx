...
import { ArrowRight, MessageCircle, Zap, Repeat } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Glow } from "@/components/ui/glow";

const PROOF = [
  { icon: MessageCircle, label: "~98% open rate" },
  { icon: Zap, label: "Replies in seconds" },
  { icon: Repeat, label: "Persistent follow-up" },
];
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center lg:px-8">
        ...
        >
          <span className="text-gradient">
            WhatsApp follow-up for real estate that never lets a lead go cold.
          </span>
        </motion.h1>
        ...
        >
          Kriven AI replies on WhatsApp the second a lead comes in — sending
          brochures, answering questions, recovering no-shows and nurturing warm
          buyers in a real two-way conversation, until the site visit is booked.
          Not a broadcast blast. A follow-up that never forgets.
        </motion.p>
