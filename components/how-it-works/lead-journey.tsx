...
const BEATS: Beat[] = [
  ...
  },
  {
    ...
    what: "Her chat lands in our Kriven AI dashboard — one inbox for every channel, tagged Instagram · reel and deduped automatically.",
    win: "No double-calls. Every lead, every channel, in one dashboard.",
    bubble: "Kriven AI dashboard · Instagram · reel",
  },
  {
    layer: "Contact",
    time: "11:05 PM",
  ...
  },
  {
    ...
    time: "11:08 PM",
    icon: Target,
    what: "Kriven AI qualifies her right in the chat — budget, configuration, timeline — and answers her price & RERA questions accurately.",
    win: "Only genuinely interested leads reach your team — and never a wrong price.",
