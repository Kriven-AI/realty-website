...
import { Article } from "@/components/blog/first-60-minutes/article";
import { POST, FAQS } from "@/components/blog/first-60-minutes/data";
...
export default function First60MinutesPage() {
  return (
    <>
      <script
