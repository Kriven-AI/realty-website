...
import { Article } from "@/components/blog/leads-not-converting/article";
import { POST, FAQS } from "@/components/blog/leads-not-converting/data";
...
export default function LeadsNotConvertingPage() {
  return (
    <>
      <script
